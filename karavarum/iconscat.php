			...
			<div class="inner">
			    ...
			    <!--[if !IE]>start section<![endif]-->
					...
					<div class="title_wrapper">
						...
						<h2>Категории иконок</h2>

						<a href="iconscatnew.php" class="view_all_orders">Новая категория</a>
					...
					<div  id="product_list">
						...
						<div class="table_wrapper">
							...
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								$zapros = mysql_query("SELECT * FROM icons_categories ORDER BY id DESC");
								...
								echo '<tr class="'.$syun.'">
									...
									<td><a href="iconscatedit.php?id='.$hamar.'" class="product_name">'.$anun.'</a></td>
									...
									<td>
										...
										<div class="actions_menu">
											...
											<ul>
												...
												<li><a class="edit" href="iconscatedit.php?id='.$hamar.'">Изм.</a></li>

												<li><a class="delete" href="iconscatdelete.php?id='.$hamar.'">Удалить</a></li>
								...
								else {echo '<li class="yellow" style="height:30px;"><span class="ico"></span><strong class="system_title">&nbsp;&nbsp;&nbsp;Категории не найдены</strong></li>';}
