...
if(isset($username) && isset($password) && isset($name) && isset($pic) && isset($rating) && isset($role))
	...
	$zapros = mysql_query("INSERT INTO users (username, password, name, pic, rating, role) VALUES ('$username', '$password', '$name', '$pic', 'rating', 'role')");

 if ($zapros == "true") { $noerror = '<li class="green"><span class="ico"></span><strong class="system_title">Удачно добавлена!</strong></li>';}
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper"><input class="text" name="username" type="text" value="" /></span>
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper"><input class="text" name="password" type="text" value="" /></span>
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper"><input class="text" name="rating" type="text" value="" /></span>
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper"><input class="text" name="role" type="text" value="" /></span>
