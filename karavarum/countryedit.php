...
$zapros = mysql_query("SELECT * FROM countries WHERE id='$id'");
...
if(!isset($_POST['name']) || $_POST['name'] == '') { $error .= '<li class="red"><span class="ico"></span><strong class="system_title">Вы не ввели название</strong></li>';} else {$name = $_POST['name'];}

if(isset($name))

	{

	$zapros = mysql_query("UPDATE countries SET name = '$name' WHERE id='$id'");
					...
					<div class="section">
						...
						<form action="" class="search_form general_form" method="post">
							...
							<fieldset>
                                ...
                                <?php /*?>  <!--[if !IE]>start row<![endif]-->

								<div class="row">

									<label>Քաղաքի մասին</label>

									<div class="inputs">

										<span class="input_wrapper textarea_wrapper_short">

											<textarea class="text" name="informacia"><? echo $petut['informacia']; ?></textarea>
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper"><input class="text" name="image" type="text" value="<? echo $petut['image']; ?>" /></span>

									</div>

								</div>

								<!--[if !IE]>end row<![endif]--><?php */?>
