...
$zapros = mysql_query("SELECT * FROM events WHERE id='$id'");
...
if(!isset($_POST['name']) || $_POST['name'] == '') { $error .= '<li class="red"><span class="ico"></span><strong class="system_title">Вы не ввели название события</strong></li>';} else {$name = $_POST['name'];}

if(!isset($_POST['description']) || $_POST['description'] == '') { $error .= '<li class="red"><span class="ico"></span><strong class="system_title">Вы не ввели описание события</strong></li>';} else {$description = $_POST['description'];}
...
if(!isset($_POST['going']) || $_POST['going'] == '') { $error .= '<li class="red"><span class="ico"></span><strong class="system_title">Вы не ввели "одобрение" события</strong></li>';} else {$going = $_POST['going'];}

if(!isset($_POST['maybe']) || $_POST['maybe'] == '') { $error .= '<li class="red"><span class="ico"></span><strong class="system_title">Вы не ввели "возможно" события</strong></li>';} else {$maybe = $_POST['maybe'];}


if(isset($name) && isset($description) && isset($area_id) && isset($going) && isset($maybe))

	{

	$zapros = mysql_query("UPDATE events SET name = '$name', description = '$description', area_id = '$area_id', going = '$going', maybe = '$maybe' WHERE id='$id'");
                               ...
                               <!--[if !IE]>start row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper textarea_wrapper_short">
											...
											<textarea class="text" name="description"><? echo $petut['description']; ?></textarea>
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper"><input class="text" name="going" type="text" value="<? echo $petut['going']; ?>" /></span>
								...
								<div class="row">
									...
									<label>Воэможно</label>

									<div class="inputs">

										<span class="input_wrapper"><input class="text" name="maybe" type="text" value="<? echo $petut['maybe']; ?>" /></span>
