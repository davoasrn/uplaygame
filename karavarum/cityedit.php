...
$zapros = mysql_query("SELECT * FROM cities WHERE id='$id'");
...
if(isset($name) && isset($country_id))

	{

	$zapros = mysql_query("UPDATE cities SET name = '$name', country_id = '$country_id' WHERE id='$id'");
