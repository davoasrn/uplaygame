			...
			<div class="inner">
			    ...
			    <!--[if !IE]>start section<![endif]-->
					...
					<div class="title_wrapper">
						...
						<a href="videonew.php" class="view_all_orders">Новое видео</a>
					...
					<div  id="product_list">
						...
						<div class="table_wrapper">
							...
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								$zapros = mysql_query("SELECT * FROM videos ORDER BY id DESC");
								...
								echo '<tr class="'.$syun.'">
									...
									<td><a href="videoedit.php?id='.$hamar.'" class="product_name">'.$anun.'</a></td>
									...
									<td>
										...
										<div class="actions_menu">
											...
											<ul>
												...
												<li><a class="edit" href="videoedit.php?id='.$hamar.'">Изм.</a></li>

												<li><a class="delete" href="videodelete.php?id='.$hamar.'">Удалить</a></li>
								...
								else {echo '<li class="yellow" style="height:30px;"><span class="ico"></span><strong class="system_title">&nbsp;&nbsp;&nbsp;Видео не найдены</strong></li>';}
