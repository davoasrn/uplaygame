...
if(isset($name) && isset($description) && isset($area_id) && isset($going) && isset($maybe))
	...
	$zapros = mysql_query("INSERT INTO events (name, description, area_id, going, maybe) VALUES ('$name', 'description', 'area_id', '$going', '$maybe')");
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper"><input class="text" name="going" type="text" value="" /></span>
								...
								<div class="row">
									...
									<label>Возможно</label>

									<div class="inputs">

										<span class="input_wrapper"><input class="text" name="maybe" type="text" value="" /></span>
