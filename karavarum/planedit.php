...
$zapros = mysql_query("SELECT * FROM plans WHERE id='$id'");
...
if(isset($name) && isset($description) && isset($area_id) && isset($user_id) && isset($map_elements) && isset($status) && isset($date) && isset($success) && isset($votes))
	...
	$zapros = mysql_query("UPDATE plans SET name = '$name', description = '$description', area_id = '$area_id', user_id = '$user_id', map_elements = '$map_elements', status = '$status', date = '$date', success = '$success', votes = '$votes' WHERE id='$id'");
                               ...
                               <!--[if !IE]>start row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper textarea_wrapper_short">
											...
											<textarea class="text" name="map_elements"><? echo $petut['map_elements']; ?></textarea>
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper"><input class="text" name="date" type="text" value="<? echo $petut['date']; ?>" /></span>
								...
								<div class="row">
									...
									<label>Успех проекта</label>

									<div class="inputs">

										<span class="input_wrapper"><input class="text" name="success" type="text" value="<? echo $petut['success']; ?>" /></span>
								...
								<div class="row">
									...
									<label>Голоса проекта</label>

									<div class="inputs">

										<span class="input_wrapper"><input class="text" name="votes" type="text" value="<? echo $petut['votes']; ?>" /></span>
