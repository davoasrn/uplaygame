...
function set_local_text($language_id)
{
	...
	*/
	...
	$text = array(
	'index_of' => array('Главная', 'Index de', 'Index der','Índice de'),
	
	'key' => array('Key', 'Clé','Schlüssel','Llave'),
	
	'folder' => array('Папка', 'Dossier','Ordner','Carpeta'),
	
	'file' => array('Файл','Fichier','Datei','Archivo'),
	...
	'launch_gallery' => array('Կանչել գալերեյան', 'Lancer la galerie','Start Galerie','Lanzamiento de la galería'),
	
	'launch_media_player' => array('Կանչել Մեդիա Փլեերը', 'Lancement media player','Starten Sie Media Player ','Lanzamiento Media Player'),
	
	'show_hide_stats' => array('Открыть/Закрыть Статистику','Afficher/cacher les statistiques','Zeigen/verstecken Statistiken','Mostrar/ocultar las estadísticas'),
	
	'name' => array('Имя', 'Nom','Name','Nombre'),
	
	'size' => array('Размер','Taille','Größe','Tamaño'),
	
	'date_uploaded' => array('Дата','Date Uploaded','Date Uploaded','Fecha de la subida'),
	
	'filesize_limit' => array('Ограничение размера файла','Taille limite','Dateigröße begrenzen','Tamaño límite'),
	
	'banned_files' => array('Не показываются эти файлы','Fichiers bannis','Banned Dateien','Prohibido archivos'),
	
	'this_page_loaded_in' => array('Страница генерирована за','Cette page chargée dans','Diese Seite wurde geladen in','Cargado en esta página'),
	
	'seconds' => array('секунд','secondes','sekunden','segundo'),
	
	'upload' => array('Добавить','Upload','Hochladen','Subir'),
	
	'select_language' => array('Select Language','Sélection de la langue','Sprache auswählen','Selección de Idioma'),
	
	'total_folders' => array('Папки','Total dossiers','Insgesamt Ordner','Total de carpetas'),
	
	'total_files' => array('Файлы','Total fichiers','Gesamt-Dateien','Total de archivos '),
	
	'total_files_and_folders' => array('Все','Combiné','Kombinierte','Combinada'),
	
	'consuming' => array('размер', 'consommation','konsum','consumir'),
	...
	'warning' => array('Ощибка', 'AVERTISSEMENT', 'WARNUNG', 'ADVERTENCIA'),
	
	'no_go_back' => array('Это действие безвозратно', 'Cette action est irréversible', 'Diese Aktion ist nicht mehr rückgängig zu', 'Esta acción es irreversible'),
	
	'sure_to_del' => array('Уверены что хотите удалить?', 'Êtes-vous sûr de vouloir supprimer','Sind Sie sicher, dass Sie löschen möchten','¿Estás seguro de que desea eliminar'),
	
	'check_for_update' => array('Проверить','Vérifier les mises à jour','Siehe, wenn Update verfügbar ist','	
Comprobar actualización '),
	...
	'current_name' => array('имя сейчас','Nom actuel','Aktuellen namen','Nombre actual'),
	
	'new_name' => array('новое имя','Nouveau nom','Neuen namen','Nuevo nombre'),
	
	'rename' => array('переименовать','Renommer','Umbenennen','Cambiar el nombre de'),
	);
