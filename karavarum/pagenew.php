...
if(isset($name) && isset($text) && isset($order_id))
	...
	$zapros = mysql_query("INSERT INTO pages (name, text, order_id) VALUES ('$name', 'text', 'order_id')");
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper textarea_wrapper_short">
											...
											<textarea class="text" name="text"><? echo $text; ?></textarea>
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper"><input class="text" name="order_id" type="text" value="" /></span>
