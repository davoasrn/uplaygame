...
$harcum = mysql_query("SELECT * FROM cities WHERE id='$id'");
...

{
	...
	$zapros = mysql_query("DELETE FROM cities WHERE id='$id'");

 if ($zapros == "true") { $noerror = '<li class="green"><span class="ico"></span><strong class="system_title">Удачно удален!</strong></li>'; $name = ''; $description = '';}
