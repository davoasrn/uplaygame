...
$zapros = mysql_query("SELECT * FROM areas WHERE id='$id'");
...
if(!isset($_POST['name']) || $_POST['name'] == '') { $error .= '<li class="red"><span class="ico"></span><strong class="system_title">Вы не ввели название города</strong></li>';} else {$name = $_POST['name'];}
...
if(isset($name) && isset($coordinates) && isset($city_id) && isset($country_id))
	...
	$zapros = mysql_query("UPDATE areas SET name = '$name', coordinates = '$coordinates', city_id = '$city_id', country_id = '$country_id' WHERE id='$id'");
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper textarea_wrapper_short">
											...
											<textarea class="text" name="coordinates"><? echo $petut['coordinates']; ?></textarea>
