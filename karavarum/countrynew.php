...
if(!isset($_POST['name']) || $_POST['name'] == '') { $error .= '<li class="red"><span class="ico"></span><strong class="system_title">Вы не ввели название страны</strong></li>';} else {$name = $_POST['name'];}

if(isset($name))

	{

	$zapros = mysql_query("INSERT INTO countries (name) VALUES ('$name')");
