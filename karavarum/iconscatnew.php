...
if(!isset($_POST['name']) || $_POST['name'] == '') { $error .= '<li class="red"><span class="ico"></span><strong class="system_title">Вы не ввели название категории</strong></li>';} else {$name = $_POST['name'];}

if(isset($name))

	{

	$zapros = mysql_query("INSERT INTO icons_categories (name) VALUES ('$name')");

 if ($zapros == "true") { $noerror = '<li class="green"><span class="ico"></span><strong class="system_title">Удачно добавлено!</strong></li>';}
