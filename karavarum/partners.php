			...
			<div class="inner">
			    ...
			    <!--[if !IE]>start section<![endif]-->
					...
					<div class="title_wrapper">
						...
						<a href="partnernew.php" class="view_all_orders">Новый партнер</a>
					...
					<div  id="product_list">
						...
						<div class="table_wrapper">
							...
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								$zapros = mysql_query("SELECT * FROM partners ORDER BY id DESC");
								...
								echo '<tr class="'.$syun.'">
									...
									<td><a href="partneredit.php?id='.$hamar.'" class="product_name">'.$anun.'</a></td>
									...
									<td>
										...
										<div class="actions_menu">
											...
											<ul>
												...
												<li><a class="edit" href="partneredit.php?id='.$hamar.'">Изм.</a></li>

												<li><a class="delete" href="partnerdelete.php?id='.$hamar.'">Удалить</a></li>
								...
								else {echo '<li class="yellow" style="height:30px;"><span class="ico"></span><strong class="system_title">&nbsp;&nbsp;&nbsp;Партнеры не найдены</strong></li>';}
