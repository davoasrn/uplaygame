...
$zapros = mysql_query("SELECT * FROM partners WHERE id='$id'");
...
if(isset($name) && isset($area_id) && isset($pic) && isset($website))
	...
	$zapros = mysql_query("UPDATE partners SET name = '$name', area_id = '$area_id', pic = '$pic', website = '$website' WHERE id='$id'");
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="inputs">
										...
										<span class="input_wrapper"><input class="text" name="website" type="text" value="<? echo $petut['website']; ?>" /></span>
